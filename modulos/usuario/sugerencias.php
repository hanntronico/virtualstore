            ...
            <div id="cont_text">
              ...
              <form name="frm_suger" action="reg_suger.php" method="post" accept-charset="utf-8" onsubmit="return valida_suger();">
                ...
                <div class="formsuger">
                  ...
                  <p><input type="text" name="txtnomape" style="width:350px" value="<?=$_SESSION["s_nombreC"]?>" readonly></p>
                  <br><br>
                  <label>
                    <div class="email"></div>
                    Correo electrónico:
                  </label>
                  <p><input type="text" name="txtemail" style="width:250px" value="<?=$_SESSION["s_correousu"]?>" readonly></p>
                  <br><br>
                  <label>
                    <div class="msn"></div>
                    Correo electrónico:
