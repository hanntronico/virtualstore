...
function carga()
{
  ...
  parent.window.location="../addcarrito.php?id="+<?php echo $_GET["id"] ?>+"&sw=2";
    ...
    <table width="100%">
        ...
        <tr>
        	<td colspan="2" align="center" class="txt_error" ><br />
              <span class="Estilo1">¿Desea agregar el producto seleccionado a su canasta de compras?</span></td>
      </tr>
      <tr>
      	<td colspan="2">&nbsp;</td>
      </tr>
