...
<?php
  ...
  if($_GET["sw"]==1){     // NUEVO
    ...
    $sql="SELECT * FROM comprobante WHERE cod_comprob='".$_GET["id"]."'"; 
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
          ...
          <thead>
            <tr>
              ...
              <th class="head1">Ticket</th>
              <th class="head1">Cod. Pedido</th>
              <th class="head1">Tipo Comprobante</th>
      ...
      <tr>
        <td>
              ...
              <p>
                ...
                <span class="field">
                <? llenarcombo('pedidos','cod_pedido, cod_pedido',' ORDER BY 2', $scat, '','codped'); ?>
                </span>
              </p>
