...
<?php
  ...
  $link=Conectarse();
  $pag = "gestion de productos - promociones ";
...
// cod_producto, descripcion, cod_subcat, precio, imagen, stock, cod_marca, estado       
  ...
  ?>
    ...
    <div id="fra_crud">
      ...
      <?php if ($_GET["msn"]=='dpr1') { ?>
        <script type="text/javascript">setTimeout("cerrar()",6000);</script>
        <div class="notibar msgsuccess">
          <a class="close" id="equis"></a>
          <p>Su registro ha sido Habilitado con exito!!!</p>;
        </div>
      <?php }  ?>

      <?php if ($_GET["msn"]=='dpr2') { ?>
        <script type="text/javascript">setTimeout("cerrar()",6000);</script>
        <div class="notibar msgsuccess">
          <a class="close" id="equis"></a>
    ...
    <!--       <tfoot>
          ...
          <?php while($row1=@mysql_fetch_array($res))
                     {$i++;
                      ...
                      if ($row1['estado']==2) {
                        $colorfil = "style='background: #C1EBFF;'";
                      }else {
                        $colorfil = "";
                      }
          ?>  
